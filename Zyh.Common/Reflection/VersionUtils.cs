//------------------------------------------------------------------------------
// <copyright file="VersionUtils.cs" company="Zyh">
//    Copyright (c) 2024, Zyh All rights reserved.
// </copyright>
// <author>Zhuo YuHan</author>
// <email>1719700768@qq.com</email>
// <date>2024/09/19 10:48:11</date>
//------------------------------------------------------------------------------
...
namespace Zyh.Common.Reflection
{
    public class VersionUtils
    {
        ...
        public static DateTime GetAssemblyCompileTime(Assembly assembly)
        {
            ...
            var attribute = assembly.GetCustomAttribute<CompileTimeAttribute>();
#else
            var attributes = assembly.GetCustomAttributes(true);
            CompileTimeAttribute attribute = null;

            foreach (var attr in attributes)
            {
                if (attr is CompileTimeAttribute)
                {
                    attribute = attr as CompileTimeAttribute;
                    break;
                }
            }
#endif
